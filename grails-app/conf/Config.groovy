...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'griffin.domain.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'griffin.domain.UserRole'
